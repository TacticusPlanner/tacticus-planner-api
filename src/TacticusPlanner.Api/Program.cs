...
builder.Services.AddUserJotFeature(builder.Configuration, validateOnStart: !isOpenApiDocumentGeneration);
builder.Services.AddV1ImportFeature(builder.Configuration);
