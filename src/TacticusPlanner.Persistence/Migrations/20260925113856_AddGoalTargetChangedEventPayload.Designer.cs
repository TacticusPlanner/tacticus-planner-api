...
namespace TacticusPlanner.Persistence.Migrations
{
    ...
    [Migration("20260925113856_AddGoalTargetChangedEventPayload")]
    partial class AddGoalTargetChangedEventPayload
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TacticusPlanner.Domain.GuildRaids.GuildRaidAttack", b =>
                {
                    ...
                    b.Property<Guid>("GuildRaidSeasonId")
                        .HasColumnType("uuid")
                        .HasColumnName("guild_raid_season_id");

                    b.Property<int>("MaximumHp")
                        .HasColumnType("integer")
                        .HasColumnName("maximum_hp");

                    b.Property<int>("ProgressionIndex")
                        .HasColumnType("integer")
                        .HasColumnName("progression_index");

                    b.Property<int>("RemainingHp")
                        .HasColumnType("integer")
                        .HasColumnName("remaining_hp");
                    ...
                    b.Property<string>("UnitSetId")
                        .IsRequired()
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)")
                        .HasColumnName("unit_set_id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_guild_raid_attacks");

                    b.HasIndex("GuildRaidSeasonId", "ContentHash")
                        .IsUnique()
                        .HasDatabaseName("ix_guild_raid_attacks_guild_raid_season_id_content_hash");

                    b.HasIndex("GuildRaidSeasonId", "TacticusUserIdHash", "CompletedAt")
                        .HasDatabaseName("ix_guild_raid_attacks_guild_raid_season_id_tacticus_user_id_ha");

                    b.ToTable("guild_raid_attacks", (string)null);
                });

            modelBuilder.Entity("TacticusPlanner.Domain.GuildRaids.GuildRaidAttackUnit", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.Property<Guid>("GuildRaidAttackId")
                        .HasColumnType("uuid")
                        .HasColumnName("guild_raid_attack_id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_guild_raid_attack_units");

                    b.HasIndex("GuildRaidAttackId", "Kind", "Position")
                        .IsUnique()
                        .HasDatabaseName("ix_guild_raid_attack_units_guild_raid_attack_id_kind_position");

                    b.ToTable("guild_raid_attack_units", (string)null);
                });

            modelBuilder.Entity("TacticusPlanner.Domain.GuildRaids.GuildRaidSeason", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.Property<string>("SeasonConfigId")
                        .IsRequired()
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_guild_raid_seasons");

                    b.HasIndex("GuildId", "SeasonNumber")
                        .IsUnique()
                        .HasDatabaseName("ix_guild_raid_seasons_guild_id_season_number");

                    b.ToTable("guild_raid_seasons", (string)null);
                });

            modelBuilder.Entity("TacticusPlanner.Domain.GuildRaids.GuildRaidSyncState", b =>
                {
                    b.Property<Guid>("GuildId")
                        .HasColumnType("uuid")
                        .HasColumnName("guild_id");
                    ...
                    b.HasKey("GuildId")
                        .HasName("pk_guild_raid_sync_states");

                    b.HasIndex("ActiveSeasonId")
                        .HasDatabaseName("ix_guild_raid_sync_states_active_season_id");

                    b.ToTable("guild_raid_sync_states", (string)null);
                });
            ...
            modelBuilder.Entity("TacticusPlanner.Domain.Projects.ProjectGoal", b =>
                {
                    ...
                    b.Property<bool>("OccupiesInFlightSlot")
                    ...
                    b.OwnsOne("TacticusPlanner.Domain.Goals.GoalConfig", "Config", b1 =>
                        {
                            ...
                            b1.OwnsMany("TacticusPlanner.Domain.Goals.AcquisitionSource", "AcquisitionSources", b2 =>
                                {
                                    b2.Property<Guid>("GoalConfigGoalId");
                                    ...
                                    b2.PrimitiveCollection<string>("Ids")
                                        .IsRequired();

                                    b2.Property<string>("Kind")
                                        .IsRequired();

                                    b2.HasKey("GoalConfigGoalId", "__synthesizedOrdinal")
                                        .HasName("pk_goals");
                            ...
                            b1.OwnsOne("TacticusPlanner.Domain.Goals.UpgradeTarget", "Upgrade", b2 =>
                                {
                                    ...
                                    b2.OwnsMany("TacticusPlanner.Domain.Goals.UpgradeMaterialTarget", "Targets", b3 =>
                                        {
                    ...
                    b.OwnsMany("TacticusPlanner.Domain.Goals.GoalEvent", "Events", b1 =>
                        {
                            ...
                            b1.OwnsOne("TacticusPlanner.Domain.Goals.GoalTargetSnapshot", "NewTarget", b2 =>
                                {
                                    b2.Property<Guid>("GoalEventGoalId");
                                    ...
                                    b2.Property<string>("ProgressionEnd");

                                    b2.Property<int?>("RankEnd");

                                    b2.Property<int?>("RankEndAppliedUpgrades");

                                    b2.Property<bool?>("RankEndPointFive");

                                    b2.HasKey("GoalEventGoalId", "GoalEvent__synthesizedOrdinal")
                                        .HasName("pk_goals");

                                    b2.ToTable("goals");

                                    b2.WithOwner()
                                        .HasForeignKey("GoalEventGoalId", "GoalEvent__synthesizedOrdinal")
                                        .HasConstraintName("fk_goals_goals_goal_event_goal_id_goal_event__synthesized_ordinal");

                                    b2.OwnsMany("TacticusPlanner.Domain.Goals.UpgradeMaterialTarget", "UpgradeTargets", b3 =>
                                        {
                                            b3.Property<Guid>("GoalTargetSnapshotGoalEventGoalId");

                                            b3.Property<int>("GoalTargetSnapshotGoalEvent__synthesizedOrdinal");
                                            ...
                                            b3.HasKey("GoalTargetSnapshotGoalEventGoalId", "GoalTargetSnapshotGoalEvent__synthesizedOrdinal", "__synthesizedOrdinal")
                                                .HasName("pk_goals");

                                            b3.ToTable("goals");

                                            b3.WithOwner()
                                                .HasForeignKey("GoalTargetSnapshotGoalEventGoalId", "GoalTargetSnapshotGoalEvent__synthesizedOrdinal")
                                                .HasConstraintName("fk_goals_goals_goal_target_snapshot_goal_event_goal_id_goal_target_sna");
                                        });

                                    b2.Navigation("UpgradeTargets");
                                });

                            b1.OwnsOne("TacticusPlanner.Domain.Goals.GoalTargetSnapshot", "PreviousTarget", b2 =>
                                {
                                    b2.Property<Guid>("GoalEventGoalId");
                            ...
                            b1.Navigation("NewTarget");

                            b1.Navigation("PreviousTarget");
                        });
            ...
            modelBuilder.Entity("TacticusPlanner.Domain.GuildRaids.GuildRaidAttack", b =>
                {
                    b.HasOne("TacticusPlanner.Domain.GuildRaids.GuildRaidSeason", "Season")
                        .WithMany("Attacks")
                        .HasForeignKey("GuildRaidSeasonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_guild_raid_attacks_guild_raid_seasons_guild_raid_season_id");
            ...
            modelBuilder.Entity("TacticusPlanner.Domain.GuildRaids.GuildRaidAttackUnit", b =>
                {
                    b.HasOne("TacticusPlanner.Domain.GuildRaids.GuildRaidAttack", "Attack")
                        .WithMany("Units")
                        .HasForeignKey("GuildRaidAttackId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_guild_raid_attack_units_guild_raid_attacks_guild_raid_attac");
            ...
            modelBuilder.Entity("TacticusPlanner.Domain.GuildRaids.GuildRaidSeason", b =>
                {
                    b.HasOne("TacticusPlanner.Domain.Guilds.Guild", "Guild")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_guild_raid_seasons_guilds_guild_id");
            ...
            modelBuilder.Entity("TacticusPlanner.Domain.GuildRaids.GuildRaidSyncState", b =>
                {
                    b.HasOne("TacticusPlanner.Domain.GuildRaids.GuildRaidSeason", "ActiveSeason")
                        .WithMany()
                        .HasForeignKey("ActiveSeasonId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_guild_raid_sync_states_guild_raid_seasons_active_season_id");

                    b.HasOne("TacticusPlanner.Domain.Guilds.Guild", "Guild")
                        .WithOne()
                        .HasForeignKey("TacticusPlanner.Domain.GuildRaids.GuildRaidSyncState", "GuildId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_guild_raid_sync_states_guilds_guild_id");
