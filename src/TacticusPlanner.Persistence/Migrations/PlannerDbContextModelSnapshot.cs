            ...
            modelBuilder.Entity("TacticusPlanner.Domain.PlayerData.PlayerDataSnapshot", b =>
                {
                    ...
                    b.OwnsOne("TacticusPlanner.Domain.PlayerData.InventoryChunk", "Inventory", b1 =>
                        {
                            ...
                            b1.OwnsMany("TacticusPlanner.Domain.PlayerData.PlayerRarityAmountRecord", "ForgeBadges", b2 =>
                                {
                            ...
                            b1.OwnsMany("TacticusPlanner.Domain.PlayerData.InventoryXpBookRecord", "XpBooks", b2 =>
                                {
                                    b2.Property<Guid>("InventoryChunkPlayerDataSnapshotId");
                            ...
                            b1.OwnsOne("TacticusPlanner.Domain.PlayerData.MowComponentsRecord", "Components", b2 =>
                                {
                                    b2.Property<Guid>("InventoryChunkPlayerDataSnapshotId");
                                    ...
                                    b2.OwnsOne("TacticusPlanner.Domain.PlayerData.ComponentAmountRecord", "Chaos", b3 =>
                                        {
                                    ...
                                    b2.OwnsOne("TacticusPlanner.Domain.PlayerData.ComponentAmountRecord", "Imperial", b3 =>
                                        {
                                            b3.Property<Guid>("MowComponentsRecordInventoryChunkPlayerDataSnapshotId");
                                    ...
                                    b2.OwnsOne("TacticusPlanner.Domain.PlayerData.ComponentAmountRecord", "Xenos", b3 =>
                                        {
                                            b3.Property<Guid>("MowComponentsRecordInventoryChunkPlayerDataSnapshotId");
                            ...
                            b1.OwnsOne("TacticusPlanner.Domain.PlayerData.PlayerAbilityBadgesRecord", "AbilityBadges", b2 =>
                                {
                                    b2.Property<Guid>("InventoryChunkPlayerDataSnapshotId");
                                    ...
                                    b2.OwnsMany("TacticusPlanner.Domain.PlayerData.PlayerRarityAmountRecord", "Chaos", b3 =>
                                        {
                                    ...
                                    b2.OwnsMany("TacticusPlanner.Domain.PlayerData.PlayerRarityAmountRecord", "Imperial", b3 =>
                                        {
                                            b3.Property<Guid>("PlayerAbilityBadgesRecordInventoryChunkPlayerDataSnapshotId");
                                    ...
                                    b2.OwnsMany("TacticusPlanner.Domain.PlayerData.PlayerRarityAmountRecord", "Xenos", b3 =>
                                        {
                                            b3.Property<Guid>("PlayerAbilityBadgesRecordInventoryChunkPlayerDataSnapshotId");
                            ...
                            b1.OwnsOne("TacticusPlanner.Domain.PlayerData.PlayerOrbsRecord", "Orbs", b2 =>
                                {
                                    b2.Property<Guid>("InventoryChunkPlayerDataSnapshotId");
                    ...
                    b.OwnsMany("TacticusPlanner.Domain.PlayerData.InventoryItemRecord", "InventoryItems", b1 =>
                        {
                            b1.Property<Guid>("PlayerDataSnapshotId");
                    ...
                    b.OwnsMany("TacticusPlanner.Domain.PlayerData.InventoryShardRecord", "InventoryShards", b1 =>
                        {
                            b1.Property<Guid>("PlayerDataSnapshotId");
                    ...
                    b.OwnsMany("TacticusPlanner.Domain.PlayerData.InventoryUpgradeRecord", "InventoryUpgrades", b1 =>
                        {
                            b1.Property<Guid>("PlayerDataSnapshotId");
                    ...
                    b.OwnsOne("TacticusPlanner.Domain.PlayerData.LiveProgressChunk", "LiveProgress", b1 =>
                        {
                            b1.Property<Guid>("PlayerDataSnapshotId");
                            ...
                            b1.OwnsMany("TacticusPlanner.Domain.PlayerData.BattleAttemptRecord", "BattleAttempts", b2 =>
                                {
                            ...
                            b1.OwnsOne("TacticusPlanner.Domain.PlayerData.GameModeTokensChunk", "GameModeTokens", b2 =>
                                {
                                    b2.Property<Guid>("LiveProgressChunkPlayerDataSnapshotId");
                                    ...
                                    b2.OwnsOne("TacticusPlanner.Domain.PlayerData.TokenBucketRecord", "Arena", b3 =>
                                        {
                                    ...
                                    b2.OwnsOne("TacticusPlanner.Domain.PlayerData.TokenBucketRecord", "Onslaught", b3 =>
                                        {
                                            b3.Property<Guid>("GameModeTokensChunkLiveProgressChunkPlayerDataSnapshotId");
                                    ...
                                    b2.OwnsOne("TacticusPlanner.Domain.PlayerData.TokenBucketRecord", "SalvageRun", b3 =>
                                        {
                                            b3.Property<Guid>("GameModeTokensChunkLiveProgressChunkPlayerDataSnapshotId");
                                    ...
                                    b2.OwnsOne("TacticusPlanner.Domain.PlayerData.GuildRaidTokensRecord", "GuildRaid", b3 =>
                                        {
                                            b3.Property<Guid>("GameModeTokensChunkLiveProgressChunkPlayerDataSnapshotId");
                                            ...
                                            b3.OwnsOne("TacticusPlanner.Domain.PlayerData.TokenBucketRecord", "BombTokens", b4 =>
                                                {
                                            ...
                                            b3.OwnsOne("TacticusPlanner.Domain.PlayerData.TokenBucketRecord", "Tokens", b4 =>
                                                {
                                                    b4.Property<Guid>("GuildRaidTokensRecordGameModeTokensChunkLiveProgressChunkPlayerDataSnapshotId")
                                                        .HasColumnName("GuildRaidTokensRecordGameModeTokensChunkLiveProgressChunkPlaye~");
                    ...
                    b.OwnsMany("TacticusPlanner.Domain.PlayerData.LreProgressRecord", "LreProgress", b1 =>
                        {
                            b1.Property<Guid>("PlayerDataSnapshotId");
                            ...
                            b1.OwnsOne("TacticusPlanner.Domain.PlayerData.LreTrackProgressRecord", "Alpha", b2 =>
                                {
                                    ...
                                    b2.OwnsMany("TacticusPlanner.Domain.PlayerData.LreEncounterProgressRecord", "Encounters", b3 =>
                                        {
                            ...
                            b1.OwnsOne("TacticusPlanner.Domain.PlayerData.LreTrackProgressRecord", "Beta", b2 =>
                                {
                                    b2.Property<Guid>("LreProgressRecordPlayerDataSnapshotId");
                            ...
                            b1.OwnsOne("TacticusPlanner.Domain.PlayerData.TokenBucketRecord", "CurrentEventTokens", b2 =>
                                {
                                    b2.Property<Guid>("LreProgressRecordPlayerDataSnapshotId");
                            ...
                            b1.OwnsOne("TacticusPlanner.Domain.PlayerData.LreTrackProgressRecord", "Gamma", b2 =>
                                {
                                    b2.Property<Guid>("LreProgressRecordPlayerDataSnapshotId");
                    ...
                    b.OwnsMany("TacticusPlanner.Domain.PlayerData.PlayerCharacterRecord", "Characters", b1 =>
                        {
                            b1.Property<Guid>("PlayerDataSnapshotId");
                            ...
                            b1.OwnsMany("TacticusPlanner.Domain.PlayerData.PlayerUnitAbilityRecord", "Abilities", b2 =>
                                {
                            ...
                            b1.OwnsMany("TacticusPlanner.Domain.PlayerData.PlayerUnitEquipmentSlotRecord", "EquippedItems", b2 =>
                                {
                                    b2.Property<Guid>("PlayerCharacterRecordPlayerDataSnapshotId");
                    ...
                    b.OwnsMany("TacticusPlanner.Domain.PlayerData.CampaignProgressRecord", "CampaignEventsProgress", b1 =>
                        {
                            b1.Property<Guid>("PlayerDataSnapshotId");
                    ...
                    b.OwnsMany("TacticusPlanner.Domain.PlayerData.CampaignProgressRecord", "CampaignProgress", b1 =>
                        {
                            b1.Property<Guid>("PlayerDataSnapshotId");
                    ...
                    b.OwnsOne("TacticusPlanner.Domain.PlayerData.PlayerDetailsChunk", "PlayerDetails", b1 =>
                        {
                            b1.Property<Guid>("PlayerDataSnapshotId");
                    ...
                    b.OwnsMany("TacticusPlanner.Domain.PlayerData.PlayerMowRecord", "Mows", b1 =>
                        {
                            b1.Property<Guid>("PlayerDataSnapshotId");
