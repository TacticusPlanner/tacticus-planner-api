...
namespace TacticusPlanner.Persistence.Migrations
{
    ...
    [Migration("20260712154653_AddAccountLastSeenAt")]
    partial class AddAccountLastSeenAt
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TacticusPlanner.Persistence.Users.Guilds.Guild", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("TacticusPlanner.Persistence.Users.Guilds.GuildMember", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("TacticusPlanner.Persistence.Users.Guilds.Guild", b =>
                {
                    b.HasOne("TacticusPlanner.Persistence.Users.Profile", "ConfiguredByProfile")
                        .WithMany()
            ...
            modelBuilder.Entity("TacticusPlanner.Persistence.Users.Guilds.GuildMember", b =>
                {
                    b.HasOne("TacticusPlanner.Persistence.Users.Guilds.Guild", "Guild")
                        .WithMany("Members")
