...
namespace TacticusPlanner.Persistence.Migrations
{
    ...
    [Migration("20260715163731_ExpandGoalSnapshots")]
    partial class ExpandGoalSnapshots
    {
        /// <inheritdoc />
                    ...
                    b.OwnsOne("TacticusPlanner.Domain.Goals.GoalConfig", "Config", b1 =>
                        {
                            ...
                            b1.OwnsOne("TacticusPlanner.Domain.Goals.ShardTarget", "Shards", b2 =>
                                {
                                    b2.Property<Guid>("GoalConfigGoalId");
